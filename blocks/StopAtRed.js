...
function runOpMode() {
  ...
  while (linearOpMode.opModeIsActive()) {
    CurrentColor = colorAccess.rgbToColor(colorRightAsColorSensor.getRed() / 3, colorRightAsColorSensor.getGreen() / 3, colorRightAsColorSensor.getBlue() / 3);
    if (colorAccess.getSaturation(CurrentColor) > 0.3 && colorAccess.getHue(CurrentColor) > 25 && colorAccess.getHue(CurrentColor) < 45) {
